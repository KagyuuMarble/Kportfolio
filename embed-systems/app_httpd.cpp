...
static esp_err_t cmd_handler(httpd_req_t *req) //funçao que le a variavel da url do server e transmite como um comando para o esp
{
    char*  buf;
    size_t buf_len;
    char variable[32] = {0,};
    ...
    else if(!strcmp(variable, "servoB")) // 3250, 4875, 6500
    {
      if(val > 645){val = 645;}
      else if (val < 326){val = 326;}
      else{   
      ledcWrite(2,10*val);
      printf("%d",val);
      }
    ...
    else if(!strcmp(variable, "servoC")) // 3250, 4875, 6500
    {
      if(val > 645){val = 645;}
      else if (val < 326){val = 326;}
      else{   
...
//error handler (padrao da camera)
...
//pagina web para mexer na camera
      ...
      <div id="stream-container" class="image-container hidden">
        ...
        <section class="main">
            <section id="buttons">
                ...
                <tr><td></td><td align="center" colspan="2"></br></tr>
                <tr><td></td><td align="center" colspan="2"></br></tr>
                <tr><td>Servo</td><td align="center" colspan="2"><input type="range" id="servoB" min="325" max="650" value="487" onchange="try{fetch(document.location.origin+'/control?var=servoB&val='+this.value);}catch(e){}"><td></td></tr>
                <tr><td>Servo</td><td align="center" colspan="2"><input type="range" id="servoC" min="325" max="650" value="487" onchange="try{fetch(document.location.origin+'/control?var=servoC&val='+this.value);}catch(e){}"><td></td></tr>
